...
public class T_PS4_GameController extends T_GameController {
	...
	public boolean getButton_Triangle() 		{ return super.joystick.getRawButton(4);	}
	public boolean getButton_Cross()        	{ return super.joystick.getRawButton(2);	}
	public boolean getButton_Circle()       	{ return super.joystick.getRawButton(3);	}
	public boolean getButton_Square()       	{ return super.joystick.getRawButton(1);	}

	public boolean getButton_Back() 			{ return super.joystick.getRawButton(9);	}
	public boolean getButton_Start() 			{ return super.joystick.getRawButton(10);	}
